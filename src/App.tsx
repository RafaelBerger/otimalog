          ...
          <main id="about" className="ultrawide-responsiveness">
            <div className="bg">
              ...
              >
                ...
                <p>
                  ...
                  inteiro para realizar a entrega. É a solução ideal para
                  empresas que precisam enviar quantidades menores de produtos,
                  mas exigem a mesma segurança, rastreabilidade e pontualidade
              ...
              >
                ...
                <p>
                  Capacidade e Segurança para operações de todos os portes.{" "}
                  <br /> <br /> Nossa estrutura foi pensada para garantir
                  eficiência em todas as etapas da movimentação de cargas. O
                  armazém da Otima.log é equipado para suportar altos volumes
                  com acesso seguro, vigilância constante e processos bem
                  definidos.
                </p>
            ...
            >
              ...
              <div className="delivery-planning-section">
                <p>
                  Nossa roteirização inteligente leva em conta todas as
                  variáveis que podem impactar uma entrega — da capacidade dos
                  veículos às restrições urbanas, passando pelas demandas
                  específicas de cada cliente. Tudo isso é feito com o objetivo
                  de garantir entregas pontuais e otimizadas.
                </p>
          ...
          <section id="contact" className="ultrawide-responsiveness">
            <div className="contact-section-container">
              <div className="contact-text-half">
                <h1>Nos Contate</h1>
                <p>
                  Entre em contato e descubra como a Ótima Log pode ser a
                  parceira estratégica que sua empresa precisa. Especialistas em
                  fretes fracionados, oferecemos agilidade, rastreabilidade e
                  controle para que sua operação cresça com eficiência e
                  segurança.
                </p>
              </div>
